...
export type BrandProfileMetrics = {
  ...
  /**
   * Preferred product-facing name for collectionsCount while WIEZ aligns on "designs".
   */
  designsCount: number;
  /**
  ...
  /**
   * Source of truth for WIEZ engagement. Aggregates public collection and collection-media THREAD counts.
   */
  totalThreads: number;
  /**
