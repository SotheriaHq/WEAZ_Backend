...
export const PRODUCT_NAME_LEGAL = 'WEAZ';
...
export const LEGAL_ENTITY_NAME_PLACEHOLDER = '[PRODUCT CONFIRMATION NEEDED]';
...
export const COPYRIGHT_OWNER_PLACEHOLDER = '[PRODUCT CONFIRMATION NEEDED]';

export const PRODUCT_BRAND_PALETTE = {
  deepNavy: '#16233f',
  softNavy: '#4b5670',
  metallicGold: '#d8b24a',
