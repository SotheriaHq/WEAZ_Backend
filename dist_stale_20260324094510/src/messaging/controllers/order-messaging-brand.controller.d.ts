...
import { MarkThreadReadDto, OpenOrderDisputeDto, QueryMessagesDto, QueryThreadSummaryDto, RequestOrderExtensionDto, SendMessageDto, UpdateThreadPreferencesDto } from '../dto/messaging.dto';
export declare class OrderMessagingBrandController {
    ...
    }, brandId: string, orderId: string, dto: RequestOrderExtensionDto): Promise<{
        statusCode: number;
        message: string;
    ...
    }, brandId: string, orderId: string, dto: OpenOrderDisputeDto): Promise<{
        statusCode: number;
        message: string;
        disputeId: string;
        messageId: string;
