...
import { MarkThreadReadDto, OpenCustomOrderDisputeDto, QueryMessagesDto, QueryThreadSummaryDto, RequestCustomOrderExtensionDto, SendMessageDto, UpdateThreadPreferencesDto } from '../dto/messaging.dto';
export declare class CustomOrderMessagingBrandController {
    ...
    }, brandId: string, orderId: string, query: QueryMessagesDto): Promise<{
        thread: {
            participants: {
                id: string;
    ...
    }, brandId: string, orderId: string, idempotencyKey: string | undefined, legacyIdempotencyKey: string | undefined, dto: SendMessageDto): Promise<{
        statusCode: number;
        replay: boolean;
        thread: {
            participants: {
    ...
    }, brandId: string, orderId: string, dto: MarkThreadReadDto): Promise<{
        success: boolean;
        threadId: any;
    ...
    }, brandId: string, orderId: string, dto: UpdateThreadPreferencesDto): Promise<{
        success: boolean;
        threadId: any;
    ...
    }, brandId: string, orderId: string, query: QueryThreadSummaryDto): Promise<{
        unreadCount: number;
        hasUnread: boolean;
    ...
    requestExtension(req: Request & {
        user: {
            id: string;
        };
    }, brandId: string, orderId: string, dto: RequestCustomOrderExtensionDto): Promise<{
    ...
    }, brandId: string, orderId: string, dto: OpenCustomOrderDisputeDto): Promise<{
        statusCode: number;
        message: string;
        disputeId: string;
        messageId: string;
