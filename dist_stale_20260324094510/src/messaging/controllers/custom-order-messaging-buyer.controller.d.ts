...
import { MarkThreadReadDto, OpenCustomOrderDisputeDto, QueryMessagesDto, QueryThreadSummaryDto, RespondCustomOrderExtensionDto, SendMessageDto, UpdateThreadPreferencesDto } from '../dto/messaging.dto';
export declare class CustomOrderMessagingBuyerController {
    ...
    }, orderId: string, requestId: string, dto: RespondCustomOrderExtensionDto): Promise<{
    ...
    }, orderId: string, dto: OpenCustomOrderDisputeDto): Promise<{
        messageThreadEventId: string;
        statusCode: number;
        message: string;
        data: {
